...
def ExprOmiVAE(input_path, expr_df, random_seed=42, no_cuda=False, model_parallelism=False,
    ...
    class VAE(nn.Module):
        ...
        def fc_layer(self, in_dim, out_dim, activation=2, dropout=False, dropout_p=0.5):
            if activation == 0:
                layer = nn.Sequential(
